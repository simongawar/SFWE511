...
{&(RES0__INSTANCE0.INLETVALVESTATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERFLOWSENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.PUMPSTATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.DISINFECTANTSTATUS), BOOL_ENUM},
{&(RES0__INSTANCE0.GASHIGHVOLUMEALERT), BOOL_ENUM},
{&(RES0__INSTANCE0.INLETCONTROL), BOOL_ENUM},
{&(RES0__INSTANCE0.OUTLETCONTROL), BOOL_ENUM},
{&(RES0__INSTANCE0.SLUDGEOUTPUMP), BOOL_ENUM},
{&(RES0__INSTANCE0.ACTIVATEPUMPADJUST), BOOL_ENUM},
{&(RES0__INSTANCE0.OVERFLOWVALVEOPEN), BOOL_ENUM},
{&(RES0__INSTANCE0.SOLIDWASTEALARM), BOOL_ENUM},
{&(RES0__INSTANCE0.FILTRATIONCONTROL), BOOL_ENUM},
{&(RES0__INSTANCE0.THICKENINGPUMP), BOOL_ENUM},
{&(RES0__INSTANCE0.DIGESTERPUMP), BOOL_ENUM},
{&(RES0__INSTANCE0.HOTWATERPUMPIN), BOOL_ENUM},
{&(RES0__INSTANCE0.HOTWATERPUMPOUT), BOOL_ENUM},
{&(RES0__INSTANCE0.GASPUMPTOTRANSPORT), BOOL_ENUM},
{&(RES0__INSTANCE0.PHVALID), BOOL_ENUM},
{&(RES0__INSTANCE0.UVLOWERSTRENGTH), BOOL_ENUM},
{&(RES0__INSTANCE0.UVINCREASESTRENGTH), BOOL_ENUM},
{&(RES0__INSTANCE0.INFLOWSENSOR), INT_ENUM},
{&(RES0__INSTANCE0.DISSOLVEDO2), INT_ENUM},
{&(RES0__INSTANCE0.PHSENSOR), INT_ENUM},
{&(RES0__INSTANCE0.TURBIDITYSENSOR), INT_ENUM},
{&(RES0__INSTANCE0.TSSSENSOR), INT_ENUM},
{&(RES0__INSTANCE0.UVPOWER), INT_ENUM},
{&(RES0__INSTANCE0.O2DEMAND), INT_ENUM},
{&(RES0__INSTANCE0.CONST5), INT_ENUM},
{&(RES0__INSTANCE0.SLUDGEPUMPVOLUME), INT_ENUM},
{&(RES0__INSTANCE0.CONST10000), INT_ENUM},
{&(RES0__INSTANCE0.PHUPPER), INT_ENUM},
{&(RES0__INSTANCE0.PHLOWER), INT_ENUM},
{&(RES0__INSTANCE0.TURBIDITYTHRESHOLD), INT_ENUM},
{&(RES0__INSTANCE0.TSSTHRESHOLD), INT_ENUM},
{&(RES0__INSTANCE0.UVUPPER), INT_ENUM},
{&(RES0__INSTANCE0.UVLOWER), INT_ENUM},
{&(RES0__INSTANCE0._TMP_GT8_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT21_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GE27_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT33_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT15_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LT46_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LT38_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_AND44_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LT40_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT56_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_AND57_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LT50_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT65_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_AND52_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_LT62_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_GT72_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0._TMP_SUB39_OUT), INT_ENUM}
};
